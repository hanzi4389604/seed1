...
class EfficientNet(nn.Module):
    ...
    def __init__(self, width_mult=1.0, depth_mult=1.0, dropout_rate=0.2, num_classes=1000, in_channels=19):
        super(EfficientNet, self).__init__()

        # yapf: disable
        settings = [
            # t,  c, n, s, k
            [1, 112, 1, 1, 3],  # MBConv1_3x3, SE, 112 -> 112
            [6, 112, 2, 2, 3],  # MBConv6_3x3, SE, 112 ->  56
            [6, 112, 2, 2, 5],  # MBConv6_5x5, SE,  56 ->  28
            [6, 112, 3, 2, 3],  # MBConv6_3x3, SE,  28 ->  14
